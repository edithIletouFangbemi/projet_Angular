...
import { GenererLicenceServeurComponent } from './pages/gestion-licence/generer-licence-serveur/generer-licence-serveur.component';
...
@NgModule({
  declarations: [
    ...
    GenererLicenceServeurComponent,
